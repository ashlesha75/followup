...
const AdminDashboard = () => {
    const [taskCounts, setTaskCounts] = useState({ totalEmployeeTasks: 0,completedTasks: 0,pendingTasks: 0,overdueTasks: 0,todayAddedTasks: 0,});
    ...
    return (
        ...
        {/* <Sidebar/> */}
        <AdminSidebar/>
            <h1 className="text-2xl font-semibold text-center mt-20 mb-2 pl-56">Admin Dashboard</h1>
                ...
                <div className="w-full sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3 p-7">
                    <div className="bg-gray-100 p-4 rounded-2xl border border-gray-200">
                        ...
                        <div className="bg-orange-500 rounded-b-2xl p-4 -m-4 mt-2 max-h-10 flex items-center justify-center">
                            <Link href='/taskList' className="text-white text-center font-bold">Total Employee tasks</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3 p-7">
                    <div className="bg-gray-100 p-4 rounded-2xl border border-gray-200">
                        ...
                        <div className="bg-green-500 rounded-b-2xl p-4 -m-4 mt-2 max-h-10 flex items-center justify-center">
                            <Link href='/completedTask' className="text-white text-center font-bold">Completed Tasks</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3 p-7">
                    <div className="bg-gray-100 p-4 rounded-2xl border border-gray-200">
                        ...
                        <div className="bg-blue-500 rounded-b-2xl p-4 -m-4 mt-2 max-h-10 flex items-center justify-center">
                            <Link href='/pending' className="text-white text-center font-bold">Pending Tasks</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3 p-7">
                    <div className="bg-gray-100 p-4 rounded-2xl border border-gray-200">
                        ...
                        <div className="bg-red-600 rounded-b-2xl p-4 -m-4 mt-2 max-h-10 flex items-center justify-center">
                            <Link href='/overdue' className="text-white text-center font-bold">Overdue Tasks</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3 p-7">
                    <div className="bg-gray-100 p-4 rounded-2xl border border-gray-200">
                        ...
                        <div className="bg-orange-600 rounded-b-2xl p-4 -m-4 mt-2 max-h-10 flex items-center justify-center">
                            <Link href='/todaysTask' className="text-white text-center font-bold">Today Added Tasks</Link>
                        </div>
                    </div>
                </div>
