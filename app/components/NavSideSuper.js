...
import { faAngleDown,faListUl, faPaperPlane, faTasks, faSquareCheck, faHourglassStart, faExclamationCircle, faPenToSquare, faTableCellsLarge, faUser, faLinesLeaning, faClipboardList, faUserPlus, faBarsStaggered, faSquarePlus,faBuilding } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-start">
                            ...
                            <Link href="https://flowbite.com" className="flex ml-2 md:mr-24">
                                ...
                                <span className="self-center text-base md:text-2xl font-semibold whitespace-nowrap dark:text-white md:pl-10 text-red-800">SuperAdmin</span>
                            </Link>
                        </div>
